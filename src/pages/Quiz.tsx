...
const Quiz: React.FC = () => {
    ...
    const setProblem = () => {
        if (Object.keys(questions).length > 0) {
            const newProblem =
                questions[Math.floor(Math.random() * Object.keys(questions).length)];
    ...
    useEffect(() => {
        const fetchQuestionsData = async () => {
            ...
            try {
                ...
                if (fetchedQuestions && Object.keys(fetchedQuestions.questions).length > 0) {
    ...
    return (
        <>
            <CourseNav />
            <div className="max-w-[924px] px-3 mx-auto my-12">
